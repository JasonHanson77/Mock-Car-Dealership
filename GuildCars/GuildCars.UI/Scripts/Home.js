...
function deleteCar(carId) {
    ...
    var url = "http://localhost:60837/Admin/Delete/" + carId;
...
function deleteSpecial(specialId) {
    ...
    var url = "http://localhost:60837/Admin/DeleteSpecial/" + specialId;
...
function searchVehicles(vehicleSearch) {
    ...
    var urlString = "http://localhost:60837/api/inventory/" + searchType + "/"  + searchTerm + "/" + minYear + "/" + maxYear + "/" + minPrice + "/" + maxPrice;
...
function searchSales() {
    ...
    var urlString = "http://localhost:60837/api/reports/sales/" + searchTerm + "/" + minYear + "/" + maxYear + "/";
